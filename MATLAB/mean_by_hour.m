function [ mean_by_hour ] = mean_by_hour( demand_ts )
...
%%
% Sum values by hour
num_events_by_hour = accumarray(hour(demand_ts.TimeInfo.Time)+1, 1);
sums_by_hour = accumarray(hour(demand_ts.TimeInfo.Time)+1, demand_ts.Data);
