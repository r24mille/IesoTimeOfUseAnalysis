function [ ontario_holidays ] = ontario_holidays_for_year( year )
%ONTARIO_HOLIDAYS_FOR_YEAR Returns a vector of datenums for each of the 
%statutory holidays in Ontario for the year passed in as a parameter.
