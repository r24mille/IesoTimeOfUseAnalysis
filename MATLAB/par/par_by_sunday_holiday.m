function [ sunday_holiday_par_ts ] = par_by_sunday_holiday( demand_ts )
...
%
%   Returns:
%   sunday_holiday_par_ts, Timeseries object of daily PAR values made up of
...
for i = 0:(num_days - 1)
    ...
    % Check that starttime is not Sunday or holiday
...
sunday_holiday_par_ts = timeseries(daily_pars(:,1), datestr(daily_pars(:,2)), ...
